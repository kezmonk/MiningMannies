...
public class OreDetectorItem extends MiningmanniesModElements.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("click down to detect"));
				list.add(new StringTextComponent("left sneak click air to toggle ore in left hand"));
			}
			...
			public void onCreated(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				double z = entity.getPosZ();
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					$_dependencies.put("itemstack", itemstack);
					OreDetectorItemIsCraftedsmeltedProcedure.executeProcedure($_dependencies);
				}
			}
		...
		public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot) {
			...
			if (equipmentSlot == EquipmentSlotType.MAINHAND) {
				multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(),
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Tool modifier", -1.8f, AttributeModifier.Operation.ADDITION));
