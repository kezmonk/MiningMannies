...
import net.mcreator.miningmannies.procedures.UpdateTickLevel22Procedure;
...
public class MiningManniSlot22Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public MiningManniSlot22Entity(MiningmanniesModElements instance) {
		super(instance, 13);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("mining_manni_slot_22")
						.setRegistryName("mining_manni_slot_22");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -13992406, -10079488, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("mining_manni_slot_22"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelPhase22MiningManni(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/phase22miningmanni.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mining Manni Phase 2.2");
					}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateTickLevel22Procedure.executeProcedure($_dependencies);
			}
		}
		...
		protected void registerAttributes() {
			...
			if (this.getAttribute(SharedMonsterAttributes.MAX_HEALTH) != null)
				this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(26);
	...
	public static class ModelPhase22MiningManni extends EntityModel<Entity> {
		...
		public ModelPhase22MiningManni() {
			textureWidth = 64;
			textureHeight = 64;
			...
			hat.setTextureOffset(56, 50).addBox(-0.45F, -5.45F, -1.4166F, 2.0F, 2.0F, 1.0F, 0.0F, false);
