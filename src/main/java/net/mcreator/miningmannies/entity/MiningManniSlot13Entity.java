...
import net.mcreator.miningmannies.procedures.UpdateTickLevel13Procedure;
...
public class MiningManniSlot13Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public MiningManniSlot13Entity(MiningmanniesModElements instance) {
		super(instance, 9);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 0.6f)).build("mining_manni_slot_13")
						.setRegistryName("mining_manni_slot_13");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -15886322, -3305132, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("mining_manni_slot_13"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelPhase13MiningManni(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/phase13miningmanni.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mining Manni Phase 1.3");
					}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateTickLevel13Procedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelPhase13MiningManni extends EntityModel<Entity> {
		...
		public ModelPhase13MiningManni() {
			textureWidth = 64;
			textureHeight = 64;
			...
			rightleg.setTextureOffset(8, 8).addBox(-1.025F, -1.0F, -2.0504F, 2.0F, 3.0F, 2.0F, 0.0F, false);
			leftleg = new ModelRenderer(this);
			leftleg.setRotationPoint(-0.375F, -1.6367F, -0.5967F);
			body.addChild(leftleg);
			leftleg.setTextureOffset(0, 8).addBox(-2.195F, -1.0F, -2.0504F, 2.0F, 3.0F, 2.0F, 0.0F, false);
		}
