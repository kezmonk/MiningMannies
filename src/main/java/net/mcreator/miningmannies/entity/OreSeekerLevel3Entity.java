...
import net.mcreator.miningmannies.procedures.UpdateSeekerTickLevel3AndDigProcedure;
...
public class OreSeekerLevel3Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public OreSeekerLevel3Entity(MiningmanniesModElements instance) {
		super(instance, 5);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.5f, 0.5f))
						.build("ore_seeker_level_3").setRegistryName("ore_seeker_level_3");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -6684877, -103, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("ore_seeker_level_3"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelSeeker1(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/seeker_3_test_skin.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Ore Seeker Level 3");
					}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateSeekerTickLevel3AndDigProcedure.executeProcedure($_dependencies);
			}
		}
