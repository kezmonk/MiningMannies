...
import net.mcreator.miningmannies.procedures.UpdateTickLevel20Procedure;
...
import net.mcreator.miningmannies.gui.HarvestGUITwoSlotsGui;
...
public class MiningManniSlot20Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public MiningManniSlot20Entity(MiningmanniesModElements instance) {
		super(instance, 12);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.5f, 0.5f)).build("mining_manni_slot_20")
						.setRegistryName("mining_manni_slot_20");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -13382656, -13369549, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("mining_manni_slot_20"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelPhase20MiningManni(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/phase20miningmanni.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(1,
					new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(Items.STONE_PICKAXE, (int) (1)).getItem()), false));
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mining Manni Phase 2.0");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new HarvestGUITwoSlotsGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateTickLevel20Procedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelPhase20MiningManni extends EntityModel<Entity> {
		...
		public ModelPhase20MiningManni() {
			textureWidth = 64;
			textureHeight = 64;
			...
			hat.setTextureOffset(0, 32).addBox(-2.45F, -5.45F, -0.2289F, 6.0F, 3.0F, 9.0F, 0.0F, false);
			rightarm = new ModelRenderer(this);
			rightarm.setRotationPoint(-4.8816F, -11.2976F, 0.3459F);
			body.addChild(rightarm);
			setRotationAngle(rightarm, 0.0F, 0.0F, 0.1745F);
			rightarm.setTextureOffset(42, 54).addBox(-2.6184F, 0.3995F, -1.9358F, 3.0F, 7.0F, 3.0F, 0.0F, false);
			...
			rightleg.setTextureOffset(52, 9).addBox(-0.25F, 0.4363F, -1.6077F, 3.0F, 4.0F, 3.0F, 0.0F, false);
			leftleg = new ModelRenderer(this);
			leftleg.setRotationPoint(-2.685F, -4.0367F, 0.0177F);
			body.addChild(leftleg);
			leftleg.setTextureOffset(52, 2).addBox(-0.915F, 0.4363F, -1.6077F, 3.0F, 4.0F, 3.0F, 0.0F, false);
		}
