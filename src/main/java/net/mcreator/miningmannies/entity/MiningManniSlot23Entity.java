...
import net.mcreator.miningmannies.procedures.UpdateTickLevel23Procedure;
...
public class MiningManniSlot23Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public MiningManniSlot23Entity(MiningmanniesModElements instance) {
		super(instance, 15);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("mining_manni_slot_23")
						.setRegistryName("mining_manni_slot_23");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -1, -16763905, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("mining_manni_slot_23"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelPhase23MiningManni(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/phase23miningmanni.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mining Manni Phase 2.3");
					}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateTickLevel23Procedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelPhase23MiningManni extends EntityModel<Entity> {
		...
		public ModelPhase23MiningManni() {
			textureWidth = 64;
			textureHeight = 64;
			...
			body.setTextureOffset(44, 38).addBox(3.0F, -13.4957F, 4.8697F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			hat = new ModelRenderer(this);
			hat.setRotationPoint(0.45F, -10.1867F, -4.1601F);
			body.addChild(hat);
			hat.setTextureOffset(55, 39).addBox(-0.95F, -6.45F, -2.4166F, 3.0F, 3.0F, 1.0F, 0.0F, false);
			hat.setTextureOffset(56, 50).addBox(-0.45F, -5.45F, -1.4166F, 2.0F, 2.0F, 2.0F, 0.0F, false);
