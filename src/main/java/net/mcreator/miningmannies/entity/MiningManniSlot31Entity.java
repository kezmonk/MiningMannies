...
import net.mcreator.miningmannies.procedures.UpdateTickLevel31Procedure;
...
public class MiningManniSlot31Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public MiningManniSlot31Entity(MiningmanniesModElements instance) {
		super(instance, 19);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("mining_manni_slot_31")
						.setRegistryName("mining_manni_slot_31");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -3368704, -103, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("mining_manni_slot_31"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelPhase31MiningManni(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/phase31miningmanni.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mining Manni Phase 3.1");
					}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateTickLevel31Procedure.executeProcedure($_dependencies);
			}
		}
		...
		protected void registerAttributes() {
			...
			if (this.getAttribute(SharedMonsterAttributes.MAX_HEALTH) != null)
				this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(43);
	...
	public static class ModelPhase31MiningManni extends EntityModel<Entity> {
		...
		public ModelPhase31MiningManni() {
			textureWidth = 64;
			textureHeight = 64;
			...
			rightarm.setTextureOffset(41, 54).addBox(-2.1184F, -0.6005F, -1.9358F, 3.0F, 7.0F, 3.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 20).addBox(-1.1904F, 5.0383F, -11.0869F, 1.0F, 1.0F, 10.0F, 0.0F, false);
			rightarm.setTextureOffset(12, 0).addBox(-1.1904F, 4.0263F, -10.0749F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			rightarm.setTextureOffset(6, 3).addBox(-1.1904F, 4.0263F, -8.0749F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 11).addBox(-1.1904F, 3.0263F, -9.0629F, 1.0F, 2.0F, 1.0F, 0.0F, false);
			rightarm.setTextureOffset(12, 3).addBox(-1.1904F, 6.0503F, -10.0749F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			rightarm.setTextureOffset(6, 0).addBox(-1.1904F, 6.0503F, -8.0749F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 6).addBox(-1.1904F, 6.0623F, -9.0629F, 1.0F, 2.0F, 1.0F, 0.0F, false);
