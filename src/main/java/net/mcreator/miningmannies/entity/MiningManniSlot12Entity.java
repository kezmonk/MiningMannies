...
import net.mcreator.miningmannies.procedures.UpdateTickLevel12Procedure;
...
public class MiningManniSlot12Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public MiningManniSlot12Entity(MiningmanniesModElements instance) {
		super(instance, 8);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 0.6f)).build("mining_manni_slot_12")
						.setRegistryName("mining_manni_slot_12");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -15563497, -10079488, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("mining_manni_slot_12"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelMiningManniBaby3(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/miningmannibaby3.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mining Manni Phase 1.2");
					}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateTickLevel12Procedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelMiningManniBaby3 extends EntityModel<Entity> {
		...
		public ModelMiningManniBaby3() {
			...
			hat.setRotationPoint(1.0F, -6.8867F, -1.5767F);
			body.addChild(hat);
			hat.setTextureOffset(0, 0).addBox(-1.25F, -1.75F, -2.263F, 2.0F, 2.0F, 4.0F, 0.0F, false);
			hat.setTextureOffset(16, 14).addBox(-2.25F, 0.25F, -1.737F, 4.0F, 1.0F, 4.0F, 0.0F, false);
