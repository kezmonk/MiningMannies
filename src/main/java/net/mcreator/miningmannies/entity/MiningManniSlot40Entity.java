...
import net.mcreator.miningmannies.procedures.UpdateTickLevel40Procedure;
...
public class MiningManniSlot40Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public MiningManniSlot40Entity(MiningmanniesModElements instance) {
		super(instance, 24);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("mining_manni_slot_40")
						.setRegistryName("mining_manni_slot_40");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -13395457, -3355444, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("mining_manni_slot_40"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelPhase40MiningManni(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/phase40miningmanni.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mining Manni Phase 4.0");
					}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateTickLevel40Procedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelPhase40MiningManni extends EntityModel<Entity> {
		...
		public ModelPhase40MiningManni() {
			textureWidth = 64;
			textureHeight = 64;
			...
			body.setTextureOffset(36, 29).addBox(3.0F, -13.4957F, 4.8697F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			body.setTextureOffset(28, 20).addBox(1.0F, -8.4957F, 4.8697F, 4.0F, 4.0F, 2.0F, 0.0F, false);
			body.setTextureOffset(28, 28).addBox(-3.0F, -7.4957F, 4.8697F, 3.0F, 3.0F, 1.0F, 0.0F, false);
			...
			hat.setTextureOffset(11, 0).addBox(-1.95F, -5.45F, -0.2289F, 5.0F, 3.0F, 9.0F, 0.0F, false);
			hat.setTextureOffset(0, 31).addBox(-0.45F, -6.45F, -0.2289F, 2.0F, 1.0F, 9.0F, 0.0F, false);
			...
			rightarm.setTextureOffset(0, 20).addBox(-1.1904F, 5.0383F, -14.0869F, 1.0F, 1.0F, 22.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 13).addBox(-1.1904F, 7.0383F, -12.0629F, 1.0F, 1.0F, 4.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 21).addBox(-1.1904F, 6.0383F, -13.0629F, 1.0F, 1.0F, 6.0F, 0.0F, false);
