...
import net.mcreator.miningmannies.procedures.UpdateTickLevel30Procedure;
...
public class MiningManniSlot30Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public MiningManniSlot30Entity(MiningmanniesModElements instance) {
		super(instance, 17);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("mining_manni_slot_30")
						.setRegistryName("mining_manni_slot_30");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -10040320, -3342541, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("mining_manni_slot_30"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelPhase30MiningManni(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/phase30miningmanni.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mining Manni Phase 3.0");
					}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateTickLevel30Procedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelPhase30MiningManni extends EntityModel<Entity> {
		...
		public ModelPhase30MiningManni() {
			textureWidth = 64;
			textureHeight = 64;
			...
			rightarm.setTextureOffset(6, 3).addBox(-1.1904F, 4.0263F, -10.0749F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 11).addBox(-1.1904F, 3.0263F, -9.0629F, 1.0F, 2.0F, 1.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 0).addBox(-1.1904F, 2.0023F, -8.0509F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			rightarm.setTextureOffset(6, 0).addBox(-1.1904F, 6.0503F, -10.0749F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 6).addBox(-1.1904F, 6.0623F, -9.0629F, 1.0F, 2.0F, 1.0F, 0.0F, false);
			rightarm.setTextureOffset(6, 8).addBox(-1.1904F, 8.0743F, -8.0509F, 1.0F, 1.0F, 1.0F, 0.0F, false);
