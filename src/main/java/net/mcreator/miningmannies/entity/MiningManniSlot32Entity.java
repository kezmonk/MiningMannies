...
import net.mcreator.miningmannies.procedures.UpdateTickLevel32Procedure;
...
public class MiningManniSlot32Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public MiningManniSlot32Entity(MiningmanniesModElements instance) {
		super(instance, 19);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("mining_manni_slot_32")
						.setRegistryName("mining_manni_slot_32");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -6711040, -6684877, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("mining_manni_slot_32"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelPhase32MiningManni(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/phase32miningmanni.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mining Manni Phase 3.2");
					}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateTickLevel32Procedure.executeProcedure($_dependencies);
			}
		}
		...
		protected void registerAttributes() {
			...
			if (this.getAttribute(SharedMonsterAttributes.MAX_HEALTH) != null)
				this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(46);
	...
	public static class ModelPhase32MiningManni extends EntityModel<Entity> {
		...
		public ModelPhase32MiningManni() {
			textureWidth = 64;
			textureHeight = 64;
			...
			rightarm.setTextureOffset(0, 6).addBox(-1.1904F, 3.0623F, -11.0629F, 1.0F, 2.0F, 5.0F, 0.0F, false);
