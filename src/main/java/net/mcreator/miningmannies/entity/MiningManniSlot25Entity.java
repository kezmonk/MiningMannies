...
import net.mcreator.miningmannies.procedures.UpdateTickLevel25Procedure;
...
public class MiningManniSlot25Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public MiningManniSlot25Entity(MiningmanniesModElements instance) {
		super(instance, 16);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("mining_manni_slot_25").setRegistryName("mining_manni_slot_25");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -10795504, -8699641, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("mining_manni_slot_25"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelPhase25MiningManni(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/phase25miningmanni.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mining Manni Phase 2.5");
					}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateTickLevel25Procedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelPhase25MiningManni extends EntityModel<Entity> {
		...
		public ModelPhase25MiningManni() {
			textureWidth = 64;
			textureHeight = 64;
			...
			body.setTextureOffset(45, 39).addBox(3.0F, -13.4957F, 4.8697F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			...
			rightarm.setTextureOffset(41, 45).addBox(-1.7087F, -0.6391F, -1.9358F, 3.0F, 1.0F, 3.0F, 0.0F, false);
			...
			leftarm.setTextureOffset(52, 18).addBox(-1.3166F, -0.6391F, -1.9358F, 3.0F, 1.0F, 3.0F, 0.0F, false);
