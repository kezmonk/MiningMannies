...
import net.mcreator.miningmannies.procedures.UpdateTickLevel33Procedure;
...
public class MiningManniSlot33Entity extends MiningmanniesModElements.ModElement {
	public static EntityType entity = null;
	public MiningManniSlot33Entity(MiningmanniesModElements instance) {
		super(instance, 20);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("mining_manni_slot_33")
						.setRegistryName("mining_manni_slot_33");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -3368704, -26317, new Item.Properties().group(MiningManniesItemGroup.tab))
				.setRegistryName("mining_manni_slot_33"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelPhase33MiningManni(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("miningmannies:textures/phase33miningmanni.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Mining Manni Phase 3.3");
					}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				UpdateTickLevel33Procedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelPhase33MiningManni extends EntityModel<Entity> {
		...
		public ModelPhase33MiningManni() {
			textureWidth = 64;
			textureHeight = 64;
			...
			rightarm.setTextureOffset(0, 20).addBox(-1.1904F, 5.0383F, -12.0869F, 1.0F, 1.0F, 11.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 6).addBox(-1.1904F, 4.0623F, -11.0629F, 1.0F, 1.0F, 5.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 6).addBox(-1.1904F, 6.0623F, -11.0629F, 1.0F, 1.0F, 5.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 6).addBox(-1.1904F, 3.0623F, -11.0629F, 1.0F, 1.0F, 4.0F, 0.0F, false);
			rightarm.setTextureOffset(0, 6).addBox(-1.1904F, 7.0623F, -11.0629F, 1.0F, 1.0F, 4.0F, 0.0F, false);
