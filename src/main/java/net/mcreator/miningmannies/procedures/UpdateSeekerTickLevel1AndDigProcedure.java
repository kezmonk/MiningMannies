...
public class UpdateSeekerTickLevel1AndDigProcedure extends MiningmanniesModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure UpdateSeekerTickLevel1AndDig!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure UpdateSeekerTickLevel1AndDig!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure UpdateSeekerTickLevel1AndDig!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure UpdateSeekerTickLevel1AndDig!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure UpdateSeekerTickLevel1AndDig!");
			return;
		}
			...
			if ((((entity.getPersistentData().getDouble("timer")) % 20) == 0)) {
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					Seeker1UpdateTickBelowAndDigProcedure.executeProcedure($_dependencies);
				}
			}
		}
	}
