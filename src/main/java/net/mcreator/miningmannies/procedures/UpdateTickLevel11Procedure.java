...
public class UpdateTickLevel11Procedure extends MiningmanniesModElements.ModElement {
	public UpdateTickLevel11Procedure(MiningmanniesModElements instance) {
		super(instance, 86);
	}
		...
		if ((entity instanceof MiningManniSlot11Entity.CustomEntity)) {
			...
			if (((entity.getPersistentData().getDouble("timer")) > (3600 / (entity.getPersistentData().getDouble("timerSpeed"))))) {
				...
				if (world instanceof World && !world.getWorld().isRemote) {
					Entity entityToSpawn = new MiningManniSlot12Entity.CustomEntity(MiningManniSlot12Entity.entity, world.getWorld());
