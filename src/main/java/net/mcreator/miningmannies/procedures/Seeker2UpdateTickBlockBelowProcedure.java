...
public class Seeker2UpdateTickBlockBelowProcedure extends MiningmanniesModElements.ModElement {
	public Seeker2UpdateTickBlockBelowProcedure(MiningmanniesModElements instance) {
		super(instance, 106);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Seeker2UpdateTickBlockBelow!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure Seeker2UpdateTickBlockBelow!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure Seeker2UpdateTickBlockBelow!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure Seeker2UpdateTickBlockBelow!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Seeker2UpdateTickBlockBelow!");
			return;
		}
		...
		if ((entity instanceof OreSeekerLevel2Entity.CustomEntity)) {
			...
			for (int index0 = 0; index0 < (int) (3); index0++) {
				if ((((ForgeRegistries.ITEMS.getKey((ItemInSlot0).getItem()).toString()))
					...
					if (((world.getBlockState(new BlockPos((int) Math.floor(x), (int) (y - (Yoffset)), (int) Math.floor(z))))
						...
						if (!world.getWorld().isRemote && world.getWorld().getServer() != null) {
							world.getWorld().getServer().getCommandManager().handleCommand(
									...
									(("/tell ") + "" + ((entity.getPersistentData().getString("ownerName"))) + "" + (" Found ") + ""
											...
											+ (" at: X ") + "" + (Math.floor(x)) + "" + (" Y ") + "" + (Math.round((y - (Yoffset)))) + "" + (" Z ")
											+ "" + (Math.floor(z))));
						}
					}
						...
						if (!world.getWorld().isRemote && world.getWorld().getServer() != null) {
							world.getWorld().getServer().getCommandManager().handleCommand(
									new CommandSource(ICommandSource.DUMMY, new Vec3d(x, y, z), Vec2f.ZERO, (ServerWorld) world, 4, "",
											new StringTextComponent(""), world.getWorld().getServer(), null).withFeedbackDisabled(),
									(("/tell ") + "" + ((entity.getPersistentData().getString("ownerName"))) + "" + (" Found ") + ""
											+ (((new ItemStack(Blocks.NETHER_QUARTZ_ORE.getDefaultState().getBlock())).getDisplayName().getString()))
											+ "" + (" at: X ") + "" + (Math.floor(x)) + "" + (" Y ") + "" + (Math.round((y - (Yoffset)))) + ""
											+ (" Z ") + "" + (Math.floor(z))));
						}
					}
				} else if ((((ForgeRegistries.ITEMS.getKey((ItemInSlot0).getItem()).toString()))
