...
public class Seeker1UpdateTickBlockBelowProcedure extends MiningmanniesModElements.ModElement {
	public Seeker1UpdateTickBlockBelowProcedure(MiningmanniesModElements instance) {
		super(instance, 104);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Seeker1UpdateTickBlockBelow!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure Seeker1UpdateTickBlockBelow!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure Seeker1UpdateTickBlockBelow!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure Seeker1UpdateTickBlockBelow!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Seeker1UpdateTickBlockBelow!");
			return;
		}
		...
		if ((entity instanceof OreSeekerLevel1Entity.CustomEntity)) {
			...
			if ((((ForgeRegistries.ITEMS.getKey((ItemInSlot0).getItem()).toString()))
					...
					if (!world.getWorld().isRemote && world.getWorld().getServer() != null) {
						world.getWorld().getServer().getCommandManager().handleCommand(
								...
								(("/tell ") + "" + ((entity.getPersistentData().getString("ownerName"))) + "" + (" Found ") + ""
										...
										+ (" at: X ") + "" + (Math.floor(x)) + "" + (" Y ") + "" + (Math.round((y - 1))) + "" + (" Z ") + ""
										+ (Math.floor(z))));
					}
				}
				...
				if (((world.getBlockState(new BlockPos((int) Math.floor(x), (int) (y - 1), (int) Math.floor(z)))).getBlock() == Blocks.REDSTONE_ORE
						.getDefaultState().getBlock())) {
					if (!world.getWorld().isRemote && world.getWorld().getServer() != null) {
						world.getWorld().getServer().getCommandManager().handleCommand(
								new CommandSource(ICommandSource.DUMMY, new Vec3d(x, y, z), Vec2f.ZERO, (ServerWorld) world, 4, "",
