...
public class UpdateSeekerTickLevel2AndDigProcedure extends MiningmanniesModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure UpdateSeekerTickLevel2AndDig!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure UpdateSeekerTickLevel2AndDig!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure UpdateSeekerTickLevel2AndDig!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure UpdateSeekerTickLevel2AndDig!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure UpdateSeekerTickLevel2AndDig!");
			return;
		}
			...
			if ((((entity.getPersistentData().getDouble("timer")) % 20) == 0)) {
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					Seeker2UpdateTickBelowAndDigProcedure.executeProcedure($_dependencies);
				}
			}
		}
	}
