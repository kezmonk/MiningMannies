...
public class UpdateTickLevel41Procedure extends MiningmanniesModElements.ModElement {
	public UpdateTickLevel41Procedure(MiningmanniesModElements instance) {
		super(instance, 133);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure UpdateTickLevel41!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure UpdateTickLevel41!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure UpdateTickLevel41!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure UpdateTickLevel41!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure UpdateTickLevel41!");
			return;
		}
		...
		if ((entity instanceof MiningManniSlot41Entity.CustomEntity)) {
			...
			if (((entity.getPersistentData().getDouble("timer")) > 3600)) {
				...
				if (world instanceof World && !world.getWorld().isRemote) {
					Entity entityToSpawn = new MiningManniSlot42Entity.CustomEntity(MiningManniSlot42Entity.entity, world.getWorld());
